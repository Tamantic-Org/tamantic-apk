...
class DetailCategoryAlatActivity : AppCompatActivity() {

    private lateinit var binding : ActivityDetailCategoryAlatBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        categoryViewModel.getSession().observe(this) { auth ->
            auth?.token.let {
                categoryViewModel.getProduct(auth.token, "Alat")
            }
        }
