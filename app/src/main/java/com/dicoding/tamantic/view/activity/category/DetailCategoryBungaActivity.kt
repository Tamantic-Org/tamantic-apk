...
import com.dicoding.tamantic.databinding.ActivityDetailCategoryBungaBinding
...
class DetailCategoryBungaActivity : AppCompatActivity() {

    private lateinit var binding : ActivityDetailCategoryBungaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDetailCategoryBungaBinding.inflate(layoutInflater)
        ...
        categoryViewModel.getSession().observe(this) { auth ->
            auth?.token.let {
                categoryViewModel.getProduct(auth.token, "Bunga")
            }
        }
