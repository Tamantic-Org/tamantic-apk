...
import com.dicoding.tamantic.databinding.ActivityDetailCategoryHiasBinding
...
class DetailCategoryHiasActivity : AppCompatActivity() {

    private lateinit var binding : ActivityDetailCategoryHiasBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDetailCategoryHiasBinding.inflate(layoutInflater)
        ...
        categoryViewModel.getSession().observe(this) { auth ->
            auth?.token.let {
                categoryViewModel.getProduct(auth.token, "Hias")
            }
        }
